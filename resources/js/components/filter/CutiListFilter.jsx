                ...
                <div className="p-1 w-full max-w-96">
                    <Select
                        ...
                        options={[
                            ...
                            { value: 'tanggal_cuti', display: 'Tanggal Cuti' },
                            { value: 'lama_cuti', display: 'Lama Cuti' },
                            { value: 'created_at', display: 'Tanggal Pengajuan' }
                        ]} />
                </div>
